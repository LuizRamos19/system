package br.com.servicemanager.usuario.controller;
...
import br.com.servicemanager.dao.UsuarioDAO;
...
public class UsuarioController implements Serializable {
	...
	public String EfetuarLogin() {
		...
		if (StringUtils.isEmpty(usuarioModel.getUsuario()) || StringUtils.isBlank(usuarioModel.getUsuario())) {
			...
			if (usuarioEntity != null) {
				...
				return "view/template?faces-redirect=true";
			} else {
	...
	public void AlteraSenha(){
		...
		this.usuarioRepository.AlteraSenha(this.usuarioModel);	
